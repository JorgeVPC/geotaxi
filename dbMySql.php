...
class DB_con
{
	...
	{
		$conn = mysqli_connect( "localhost", "root", "","db_geotaxi") or die ("No se ha podido conectar al servidor de Base de datos");
		//mysqli_select_db( $conn, "dbtuts" ) or die ( "Upps! Pues va a ser que no se ha podido conectar a la base de datos" );
	}
	public function login($usuario,$password)
	{
		$conn = mysqli_connect( "localhost", "root", "","db_geotaxi");
